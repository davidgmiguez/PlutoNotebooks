...
begin
	...
	img_brain=load("img/brain.jpg");
	img_pathway=load("img/pathway.jpg");
	img_water=load("img/water.jpg");
	img_solar = load("img/solar_system.jpg");
	img_clock=load("img/Clockwork.jpg");
	img_dices=load("img/dices.jpg");
	img_plant=load("img/plant.jpg");
end

# ╔═╡ 49c057a5-0c39-4525-be8a-4575d44b9443
using PlutoSliderServer

# ╔═╡ 91812a72-a643-4d13-981d-5e83df102335
...
LocalResource("./img/complexity.jpg")
...
A set of of interacting proteins in a signaling pathway is *diverse*, since it is composed of many units of different elements that they are different to each other"
...
Complex systems can have another important property that may play a role in biological systems: they can be more robust than linear systems. In other words,  they are less sensitive to changes in the environment, compared to simple systems. It is clear that this property may highly desired in biological systems such as populations of animals or plants, or sets of cells that have to form an organ or an individual. For instance, it is well knowns that flies can develop at different temperatures, and given that the rate of chemical reactions depends on the temperature, via the famous Arrhenius Equation:
```math
k = A e^{-E_a/RT} 
```
...
md" ## iv)  __Global__ scale properties 
...
# ╔═╡ fe82159e-0020-44af-8ce3-443b0fc401ac
path_to_notebook = "/home/user/2 Networks as Complex Systems.jl" #download("https://raw.githubusercontent.com/fonsp/Pluto.jl/v0.17.2/sample/Interactivity.jl") # fill in your own notebook path here!
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "7a4979a546ce891ee892eaf5e7efdda267c1bd0c"
...
git-tree-sha1 = "bd06ce7d7e3d0bae4916b1de88a8aa52e26aa7e9"
