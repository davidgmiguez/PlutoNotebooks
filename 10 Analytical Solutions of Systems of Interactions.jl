...
# ╔═╡ 2e0b9fb3-bc70-4b64-891d-0ffd82d7d1c3
md"
> ## Exercise 1: 
...
# ╔═╡ 738982ad-3960-4553-bebc-298f7167db59
begin
	X1 = @bind 🐶 html"<input type=range min=0.1 max=2.0 step=0.1>"
	X2 = @bind 🐱 html"<input type=range min=0.1 max=2.0 step=0.1>"
	md"""
	
	*Solution Exercise 1: Use the sliders to set the initial conditions*
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "0eeaa0100162bfdf2bc73537924886f58489fa77"
