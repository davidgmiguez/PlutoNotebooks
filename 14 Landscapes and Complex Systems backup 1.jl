...
# ╔═╡ 38adb4c1-b2d0-4b32-a423-e1e1bda57a95
using GLMakie

# ╔═╡ 7cdcdc9d-7c47-4fc2-acc2-cc66a15e02c8
using Makie, AbstractPlotting

# ╔═╡ c7304b77-70a5-444f-9199-eff5539e65bc
md" # 5 Representation of Dynamical Systems 
Since the complex systems are often not-solvable anitically, ww have to find ways to represet their dynamcis and response. One of the most useful tools is to represent grafically aspects of their dynamics. 

Phase planes and energy landscapes. 

## 5.1 Time evolution

One of the axis is time, and the other axis correspond to the value of the variable of interest. This is what we do when we have an analitical or numerical solution of the system. To observe the dynamics, we just need to follow the change of the curve as time progresses. We can see where the system moves and how fast or slow the dynamcis is. 

## 5.1 Phase plane

When we do not have the full solution (analitically or numerically), it is useful to represent a plot where the value of the variables are in each of the axis. This is called a _phase plane_. In this representation, each point a posible state of the system. The dynamcis of the system is then represented by a trajectory in this representation. In two dimensional systems we can see
plane is called the phase plane.
